...
namespace ProyectoFinalAp2.Migrations
{
    public partial class New_Migration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Productos",
                columns: new[] { "ProductoId", "Cantidad", "CategoriaiD", "Costo", "Descripcion", "Donativo", "Fecha", "Ganancia", "Precio" },
                values: new object[] { 1, 25, 1, 100m, "Zapato", false, new DateTime(2020, 7, 6, 11, 9, 7, 747, DateTimeKind.Local).AddTicks(2907), 50m, 150m });

            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "UsuarioId", "FechaIngreso", "Nivel", "NombreUsuario", "Nombres", "PassWord" },
                values: new object[] { 1, new DateTime(2020, 7, 6, 11, 9, 7, 746, DateTimeKind.Local).AddTicks(267), "Administrador", "Rguez12", "Elian Garcia", "uMbRelLa1772" });
